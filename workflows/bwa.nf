...
process bwa_idx{
    ...
    saveAs: {filename ->
        ...
        else if (filename.indexOf("Log.out") > 0)           "LOGS/${COMBO}/${CONDITION}/MAPPING/bwa/index.log"
        else                                                "$MAPUIDX"
    }
...
process bwa_mapping{
    ...
    publishDir "${workflow.workDir}/../" , mode: 'link',
        ...
        else if (filename.indexOf(".log") >0)          "LOGS/${COMBO}/${CONDITION}/MAPPING/bwa/${file(filename).getName()}"
        else null
    }
