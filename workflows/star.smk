...
rule generate_index:
    ...
    output: idx = directory(INDEX),
            ...
            dummy = expand("{refd}/INDICES/{mape}_{unikey}/{mape}.idx", refd=REFDIR, mape=MAPPERENV, unikey=get_dict_hash(subDict(tool_params(SAMPLES[0], None, config, 'MAPPING', MAPPERENV)['OPTIONS'], ['INDEX'])))
