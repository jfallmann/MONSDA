...
rule themall:
    input:  session = expand("{outdir}/DAS_EDGER_{combi}_SESSION.gz", outdir=outdir, combi=combi),
...
rule run_edgerDAS:
    ...
    output: session = rules.themall.input.session,
            allM    = expand("{outdir}/Figures/DAS_EDGER_{combi}_DataSet_figure_AllConditionsMDS.png", outdir=outdir, combi=combi),
            allsM   = expand("{outdir}/Figures/DAS_EDGER_{combi}_DataSet_figure_AllConditionsSumMDS.png", outdir=outdir, combi=combi),
            allBCV  = expand("{outdir}/Figures/DAS_EDGER_{combi}_DataSet_figure_AllConditionsBCV.png", outdir=outdir, combi=combi),
            allQLD  = expand("{outdir}/Figures/DAS_EDGER_{combi}_DataSet_figure_AllConditionsQLDisp.png", outdir=outdir, combi=combi),
            resG    = expand("{outdir}/Tables/DAS_EDGER_{combi}_{comparison}_table_resultsGeneTest.tsv.gz", outdir=outdir, comparison = compstr, combi=combi),
            list    = expand("{outdir}/Figures/DAS_EDGER_{combi}_{comparison}_list_topSpliceSimes.tsv", outdir=outdir, comparison = compstr, combi=combi),
            resS    = expand("{outdir}/Tables/DAS_EDGER_{combi}_{comparison}_table_resultsSimesTest.tsv.gz", outdir=outdir, comparison = compstr, combi=combi),
            resE    = expand("{outdir}/Tables/DAS_EDGER_{combi}_{comparison}_table_resultsDiffSpliceExonTest.tsv.gz", outdir=outdir, comparison = compstr, combi=combi)
