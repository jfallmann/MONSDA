...
process FindPeaks{
    ...
    saveAs: {filename ->
        ...
        else if (filename == ".log")        "LOGS/${SCOMBO}/${CONDITION}/PEAKS/macs2/findpeaks_${file(filename).getName()}.log"
    }
...
process PeakToBedg{
    ...
    saveAs: {filename ->
        ...
        else if (filename == ".log")        "LOGS/${SCOMBO}/${CONDITION}/PEAKS/macs2/${file(filename).getName()}_peaktobedgraph.log"
    }
...
process NormalizeBedg{
    ...
    saveAs: {filename ->
        ...
        else if (filename == ".log")        "LOGS/${SCOMBO}/${CONDITION}/PEAKS/macs2/${file(filename).getName()}_ucscpeaknormalizebedgraph.log"
    }
...
process PeakToTRACKS{
    ...
    saveAs: {filename ->
        ...
        else if (filename == ".log")        "LOGS/${SCOMBO}/${CONDITION}/TRACKS/macs2/${file(filename).getName()}_peaktoucsc.log"
    }
...
process GenerateTrack{
    ...
    saveAs: {filename ->
        ...
        else if (filename == ".log")        "LOGS/${SCOMBO}/${CONDITION}/TRACKS/macs2/${file(filename).getName()}"
    }
