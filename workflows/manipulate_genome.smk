...
rule UnzipGenome_no_us:
    ...
    log:    expand("LOGS/{combo}/MAPPING/samtools/indexfa_us.log", combo=combo)
    conda:  "samtools.yaml"
    container: "oras://jfallmann/monsda:samtools"
    threads: 1
    params: bins = BINS
