...
process salmon_quant{
    ...
    if (PAIRED == 'paired'){
        ...
        """
        $COUNTBIN $COUNTPARAMS quant -p $THREADS -i $idx $stranded -o $fn -1 $r1 -2 $r2 &>> $lf && gzip $of && ln -z $oz $ol
        """
    }else{
        ...
        ol = fn+"_mapped_sorted_unique_counts.gz"
        """
        $COUNTBIN $COUNTPARAMS quant -p $THREADS -i $idx $stranded -o $fn -r $read &>> $lf && gzip $of && ln -s $oz $ol
        """
    }
}
