...
if paired == 'paired':
    ...
    rule qc_raw:
        ...
        output: o1 = report("{outdir}{rawfile}_{read}_fastqc.zip", category="QC")
    ...
    rule multiqc:
        ...
        output: html = report("{moutdir}DEDUP_TRIMMED_RAW/{condition}/multiqc_report.html", category="QC"),
                tmp = temp("{moutdir}DEDUP_TRIMMED_RAW/{condition}/tmp"),
                lst = "{moutdir}DEDUP_TRIMMED_RAW/{condition}/qclist.txt"
