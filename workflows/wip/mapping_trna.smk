...
###snakemake -n -j 20 --software-deployment-method conda -s Workflow/workflows/mapping.smk --configfile Workflow/config_compare.json --directory ${PWD} --printshellcmds 2> run.log
