    ...
    if analysis == 'DEU':
        rule featurecount_unique:
            ...
            output: "COUNTS/Featurecounter_dexseq/{file}_mapped_sorted_unique.counts",
                    "COUNTS/Featurecounter_dexseq/{file}_dexseq.gtf"
            ...
            shell:  "{params.bins}/Analysis/"+analysis+"/prepare_dexseq_annotation2.py {params.anno} {params.tmpgtf} && ln -s {params.tmpgtf} {output[1]} && {params.count} -T {threads} {params.cpara} {params.paired} {params.stranded} -a {output[1]} -o {output[0]} {input[0]} 2> {log}"
