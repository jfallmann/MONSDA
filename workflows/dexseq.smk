for analysis in ['DE', 'DEU', 'DAS']:
    ...
    if analysis == 'DEU':
        rule featurecount_unique:
            ...
            shell:  "if [ ! -f \"{params.dexgtf}\" || ! -f \"{params.countgtf}\" ];then {params.bins}/Analysis/DEU/prepare_dexseq_annotation2.py -f {params.countgtf} {params.anno} {params.dexgtf} ;fi && ln -s {params.dexgtf} {output.anno} && {params.count} -T {threads} {params.cpara} {params.paired} {params.stranded} -a {params.countgtf} -o {output.cts} {input.mapf} 2> {log}"
