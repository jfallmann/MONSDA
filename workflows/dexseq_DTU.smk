...
rule themall:
    input:  session = expand("{outdir}/DTU_DEXSEQ_{combi}_SESSION.gz", outdir=outdir, combi=combi),
            Rmd = expand("REPORTS/SUMMARY/RmdSnippets/SUM_DTU_DEXSEQ.Rmd")
...
rule run_DTU:
    ...
    output: session = rules.themall.input.session,
            res = expand("{outdir}/Tables/DTU_DEXSEQ_{combi}_{comparison}_table_results.tsv.gz", outdir=outdir, combi=combi, comparison=compstr),
...
#     output: sig = expand("{outdir}/Tables/Sig_DTU_DEXSEQ_{combi}_{comparison}_results.tsv.gz", outdir=outdir, combi=combi, comparison=compstr),
#             sig_d = expand("{outdir}/Tables/SigDOWN_DTU_DEXSEQ_{combi}_{comparison}_results.tsv.gz", outdir=outdir, combi=combi, comparison=compstr),
#             sig_u = expand("{outdir}/Tables/SigUP_DTU_DEXSEQ_{combi}_{comparison}_results.tsv.gz", outdir=outdir, combi=combi, comparison=compstr)
