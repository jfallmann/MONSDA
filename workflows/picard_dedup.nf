...
process dedup{
    ...
    """
    mkdir -p tmp && $DEDUPBIN $JAVAPARAMS MarkDuplicates $DEDUPPARAMS --REMOVE_DUPLICATES --ASSUME_SORTED --TMP_DIR=tmp INPUT=$samples OUTPUT=$out &> dedup.log && samtools index $out &>> dedup.log
    """
}
