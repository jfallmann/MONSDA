...
process dedup{
    ...
    """
    mkdir -p tmp && java $JAVAPARAMS -jar $DEDUPBIN\.jar MarkDuplicates $DEDUPPARAMS --REMOVE_DUPLICATES --ASSUME_SORTED --TMP_DIR=tmp INPUT=$samples OUTPUT=$out &> dedup.log && samtools index $out &>> dedup.log
    """
}
