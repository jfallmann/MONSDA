...
params.gIDXPARAMS = get_always('dexseq_DTU_params_INDEX') ?: ''
params.gCOUNTPARAMS = get_always('dexseq_DTU_params_COUNT') ?: ''
params.gDTUPARAMS = get_always('dexseq_DTU_params_DTU') ?: ''
params.gRUNTERMINUS = get_always('dexseq_DTU_params_TERMINUS') ?: ''
...
process salmon_idx{
    ...
    """
    ${params.gCOUNTBIN} index ${params.gIDXPARAMS} $decoy -p ${task.cpus} -t $gen -i ${params.gDTUUIDXNAME} &> index.log && ln -fs ${params.gDTUUIDXNAME} dexseq.idx
    """
}
