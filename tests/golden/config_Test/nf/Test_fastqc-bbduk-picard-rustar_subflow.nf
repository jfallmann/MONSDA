...
process rustar_idx{
    ...
    saveAs: {filename ->
        if (filename.indexOf("Log.out") > 0)             "LOGS/${params.gCOMBO}/${params.gCONDITION}/rustar_index.log"
...
process rustar_mapping{
    ...
    saveAs: {filename ->
        ...
        else if (filename.indexOf(".log") >0)        "LOGS/${params.gCOMBO}/${params.gCONDITION}/MAPPING/rustar_"+"${file(filename).getName()}"
        else if (filename.indexOf(".out") >0)        "LOGS/${params.gCOMBO}/${params.gCONDITION}/MAPPING/rustar_"+"${file(filename).getName()}"
