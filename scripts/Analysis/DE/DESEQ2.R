...
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "PCA.png", sep = "_"), width = 400, height = 350, res = 45)
...
last <- ord[length(ord)]
vstcol <- c("blue", "black")
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "VST-and-log2.png", sep = "_"),width=400,height=350,res=45)
...
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "heatmap1.png", sep = "_"), width = 400, height = 350, res = 45)
...
dev.off()
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "heatmap2.png", sep = "_"), width = 400, height = 350, res = 45)
...
dev.off()
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "heatmap3.png", sep = "_"), width = 400, height = 350, res = 45)
...
hc <- hclust(distsRL)
png(paste("Figures/DE", "DESEQ2", combi, "DataSet", "figure", "heatmap-samplebysample.png", sep = "_"), width = 400, height = 350, res = 45)
heatmap.2(mat,
...
for (contrast in comparison[[1]]) {
    ...
    if (spike != "") {
        ...
        png(paste("Figures/DE", "DESEQ2", combi, contrast_name, "figure", "PCA_norm.png", sep = "_"), width = 400, height = 350, res = 45)
    ...
    png(paste("Figures/DE", "DESEQ2", combi, contrast_name, "figure", "PCA.png", sep = "_"), width = 400, height = 350, res = 45)
    ...
    tryCatch({
        ...
        # plotMA
        png(paste("Figures/DE", "DESEQ2", combi, contrast_name, "figure", "MA.png", sep = "_"), width = 400, height = 350, res = 45)
        ...
        if (spike != "") { # DE run for spike-in normalized data
            ...
            # plotMA
            png(paste("Figures/DE", "DESEQ2", combi, contrast_name, "figure", "MA_norm.png", sep = "_"), width = 400, height = 350, res = 45)
            DESeq2::plotMA(res)
            dev.off()
        }
        # cleanup
