...
```{r, DTU_DRIMSEQ_files, include = TRUE, echo = TRUE, message = TRUE, warning = TRUE}
...
```
```{r, DTU_DRIMSEQ_read_tables, include = TRUE, echo = FALSE, message = FALSE, warning = TRUE}
library(tidyr)
...
#### f.1
```{r, DTU_DRIMSEQ_tables_1, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(all_genes)
```

#### f.2
```{r, DTU_DRIMSEQ_tables_2, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(proportions)
```
#### f.3
```{r, DTU_DRIMSEQ_tables_3, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(sig_all_genes)
```

#### f.4
```{r, DTU_DRIMSEQ_tables_4, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(sig_down_genes)
```

#### f.5
```{r, DTU_DRIMSEQ_tables_5, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(sig_up_genes)
```

#### f.6
```{r, DTU_DRIMSEQ_tables_6, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(sig_all_transcripts)
```

#### f.7
```{r, DTU_DRIMSEQ_tables_7, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
DT::datatable(sig_down_transcripts)
```

#### f.8
```{r, DTU_DRIMSEQ_tables_8, include = TRUE, echo = FALSE, message = TRUE, warning = FALSE}
library(DT)
...
```{r, DTU_DRIMSEQ_overviewTable, echo=FALSE, results = 'asis', warning = FALSE}
library(knitr)
library(kableExtra)
...
```{r, DTU_DRIMSEQ_sigTable, echo=FALSE, results = 'asis', warning = FALSE}
library(knitr)
library(kableExtra)
...
```{r, DTU_DRIMSEQ_DRIMTable, echo=FALSE, results = 'asis', warning = FALSE}
library(knitr)
library(kableExtra)
library(tidyr)
...
```{r, DTU_DRIMSEQ_definePlotHeight, echo=F, warning = T}
of_interest <- all_genes[all_genes$adj_pvalue < 0.05,]
plot_height <- 2 * round(nrow(of_interest)/2)
```


```{r DTU_DRIMSEQ_DTUplots, fig.width=10, fig.height=plot_height, echo=FALSE, message = TRUE, warning = FALSE}
