...
for (contrast in comparisons[[1]]) {
    ...
    tryCatch({
        ...
        tryCatch(
            {
                png(paste("Figures/DTU", "DRIMSEQ", combi, contrast_name, "figure", "FeatPerGene.png", sep = "_"), width = 400, height = 350, res = 45)
                print(plotData(d))
                dev.off()
            },
            warning = function(w) {
        ...
        ## Plot precision
        png(paste("Figures/DTU", "DRIMSEQ", combi, contrast_name, "figure", "Precision.png", sep = "_"), width = 400, height = 350, res = 45)
        print(plotPrecision(d))
        dev.off()

        ## Plot gene-level p-values
        png(paste("Figures/DTU", "DRIMSEQ", combi, contrast_name, "figure", "PValues.png", sep = "_"), width = 400, height = 350, res = 45)
        print(plotPValues(d))
        dev.off()
        ...
        for (gene in sigs) {
            ...
            png(name1, width = 400, height = 350, res = 45)
            ...
            png(name2, width = 400, height = 350, res = 45)
            ...
            png(name3, width = 400, height = 350, res = 45)
